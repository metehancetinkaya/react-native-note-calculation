...
export default class NotHesaplama extends Component {
    ...
    temizleButon() {
        this.vizeInput.clear();
        this.finalInput.clear();
        this.ortalamaInput.clear();
        this.sapmaInput.clear();
    }
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={{ flex: 1 }}>
                            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#212121' }}>Harfli Not Hesaplama</Text>
                            </View>
                                ...
                                <View style={{ marginVertical: 11, flexDirection: 'row' }}>
                                    <View style={styles.text}>
                                        ...
                                        <TextInput
                                            ...
                                            ref={(input) => this.vizeInput = input}
                                            onSubmitEditing={() => this.finalInput.focus()}
                                            returnKeyType='Final'
                                        />
                                    </View>
                                    <View style={styles.text}>
                                        ...
                                        <TextInput
                                            ...
                                            ref={(input) => this.finalInput = input}
                                            onSubmitEditing={() => this.ortalamaInput.focus()}
                                            returnKeyType='Ortlm'
                                        />
                                    </View>
                                </View>
                                <View style={{ marginVertical: 11, flexDirection: 'row' }}>
                                    <View style={styles.text}>
                                        ...
                                        <TextInput
                                            ...
                                            ref={(input) => this.ortalamaInput = input}
                                            onSubmitEditing={() => this.sapmaInput.focus()}
                                            returnKeyType='Sapma'
                                        />
                                    </View>
                                    <View style={styles.text}>
                                        ...
                                        <TextInput
                                            ...
                                            ref={(input) => this.sapmaInput = input}
                                        />
                                    </View>
                                </View>
                                <View style={{ flexDirection: 'row' }}>
                                    <TouchableOpacity style={styles.buttonSize}
                                        onPress={() => this.hesaplaButon()}>
                                        <Text style={{ fontSize: 23, color: 'white' }}>Hesapla</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.clearButtonSize}
                                        onPress={() => this.temizleButon()}>
                                        <Text style={{ fontSize: 23, color: 'white' }}>X</Text>
                                    </TouchableOpacity>
                                </View>
